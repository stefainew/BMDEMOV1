...
const values = [
  {
    ...
    desc: 'Всяка коса е различна и заслужава специално отношение. Консултирам се с вас, за да намеря идеалното решение.',
  },
  {
    num: '02',
    code: 'QUALITY',
    title: 'Премиум продукти',
    desc: 'Работя само с висок клас марки. Вашата коса получава грижата, която заслужава, с безопасни и ефективни формули.',
  },
  {
    num: '03',
    code: 'MASTERY',
    title: 'Опит и занаят',
    desc: '25+ години опит, работа по филми, реклами и ТВ продукции. Боби е истински майстор на своята работа.',
  },
]
...
const timeline = [
  {
    year: '1999',
    title: 'Началото',
    body: 'Боби започва своя път с любов към занаята и мечта да създава не просто прически, а цели изживявания. Първите стъпки — с голяма визия и безграничен ентусиазъм.',
  },
  {
    year: '2010',
    title: 'Екранът и подиумът',
    body: 'Работа по филмови продукции, рекламни кампании и ТВ предавания. Опитът зад кадъра научи Боби на нещо, което рядко се учи — перфекцията под натиск.',
  },
  {
    year: 'ДНЕС',
    title: 'Боби Ярчев',
    body: 'Над 25 години опит, превърнати в методология: слушай, консултирай, изпълни перфектно. Боби Ярчев — майстор фризьор, работещ в сърцето на София.',
  },
]
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-8 md:px-20 pb-24 w-full">
          <div className="grid md:grid-cols-2 gap-16 items-end">
            ...
            >
              ...
              >
                "Боби Ярчев е повече от фризьор. Това е човек, за когото всяка коса е отделна история."
              </p>
              <span
                style={{
          ...
          <div className="grid md:grid-cols-2 gap-20 items-center">
            ...
            >
              ...
              >
                Един майстор.
                <br />
                <em style={{ fontWeight: 300 }}>Един уникален език</em>
                <br />
                с косата.
              </h2>
              <div style={{ fontFamily: "'Lora', serif", color: '#5C5448', lineHeight: 1.85, fontSize: '0.98rem' }}>
                <p style={{ marginBottom: '1.25rem' }}>
                  Аз съм Боби Ярчев – с над 25 години професионален опит в света на красотата. Моят път започна с любов към занаята и желание да създавам не просто прически, а цели изживявания.
                </p>
                <p>
                  Работил съм по филми, реклами и ТВ продукции, придобивайки опит, който малко фризьори могат да предложат. Днес Боби Ярчев е синоним на качество, индивидуален подход и модерни техники в сърцето на София.
                </p>
              </div>
            </motion.div>
      ...
      <section style={{ backgroundColor: '#F5F0E8' }}>
        <div className="max-w-5xl mx-auto px-8 md:px-20 py-32 text-center">
          ...
          >
            ...
            >
              "Вашата красота е<br />
              <em style={{ fontWeight: 300 }}>моята мисия."</em>
            </blockquote>
            <p
              style={{
                fontFamily: "'Lora', serif",
            ...
            >
              Вярвам, че всяко посещение трябва да е изживяване: индивидуален подход, модерни техники и атмосфера на лукс. Моята цел е да ви помогна да откриете своя уникален стил.
            </p>
          </motion.div>
        </div>
      </section>
