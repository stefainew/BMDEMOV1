...
const timeline = [
  {
    year: '1999',
    title: 'Началото',
    body: 'Боби започва своя път с любов към занаята и мечта да създава не просто прически, а цели изживявания. Първите стъпки — в малко ателие, но с голяма визия.',
  },
  {
    year: '2010',
    title: 'Екранът и подиумът',
    body: 'Работа по филмови продукции, рекламни кампании и ТВ предавания. Опитът зад кадъра научи Боби на нещо, което рядко се учи в салон — перфекцията под натиск.',
  },
  {
    year: 'ДНЕС',
            ...
            >
              ...
              <div style={{ fontFamily: "'Lora', serif", color: '#5C5448', lineHeight: 1.85, fontSize: '0.98rem' }}>
                <p style={{ marginBottom: '1.25rem' }}>
                  Аз съм Боби – с над 25 години професионален опит в света на красотата. Моят път започна с любов към занаята и желание да създавам не просто прически, а цели изживявания.
                </p>
                <p>
